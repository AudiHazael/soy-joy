  ...
  return (
    <section className="pt-4 pb-4 bg-[#f5ead8a1]">
      <div className="max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="flex flex-col items-center justify-center py-12 px-4 my-12 bg-[#f4dcb5] shadow-sm border-amber-500 transition transition-discrete hover: duration-300"
          data-aos="zoom-in"
        ...
        <div
          className="text-center bg-transparent shadow-sm border border-[#f4dcb5] rounded-lg  py-10 px-6"
          data-aos="zoom-in"
          data-aos-easing="ease-in-out"
          data-aos-delay="500"
          data-aos-duration="1000"
